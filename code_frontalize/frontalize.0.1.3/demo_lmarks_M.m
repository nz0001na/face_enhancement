...
%creat result file
dst = 'F:\zn1\znMCM\MsCeleb1M_code\frontalize_output\low_landmark_xyz_rgb\';
    if ~exist(dst, 'dir')
        mkdir('F:\zn1\znMCM\MsCeleb1M_code\frontalize_output\low_landmark_xyz_rgb\');  
    end
poselist = 'F:\zn1\znMCM\MsCeleb1M_code\code_openface\pose_list\low_do_xyz_rgb\';
landmarkdir = 'F:\zn1\znMCM\MsCeleb1M_code\code_openface\heuristic_rgb\low_pose\';

for n = 415:length(nameFolds)
