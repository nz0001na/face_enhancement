...
pathFolder = 'F:\zn1\znMCM\MsCeleb1M_code\cropped_output\deblur\low_sharpness_new';
d = dir(pathFolder);
isub = [d(:).isdir]; 
...
%creat result file
dst = '../../deblur_output/low_sharpness_new_match_examplar/';
    if ~exist(dst, 'dir')
        mkdir('../../deblur_output/low_sharpness_new_match_examplar/');  
    end
    
% blurlist = 'F:\zn1\znMCM\MsCeleb1M_code\code_openface\blur_list\low_focus_frontal\';
