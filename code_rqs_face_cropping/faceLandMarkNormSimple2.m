...
function crgr = faceLandMarkNormSimple2(I, landmark)
...
%     dx = 0.1; dy = 0.1;
%     a = [1:length(landmark(1:7))]'; b = num2str(a); c = cellstr(b);
%     imshow(I); hold on; scatter(landmark(1:7)',landmark(8:14)', 'filled'); text(landmark(1:7)+dx, landmark(8:14)+dy, c);
