...
pathFolder = 'F:\zn1\znMCM\MsCeleb1M_code\code_face_recognition_enhancedface_with_VGGface\VGG_feature_output\photo_low\';
d = dir(pathFolder);
...
%creat result folder
dst = 'F:\zn1\znMCM\MsCeleb1M_code\code_face_recognition_enhancedface_with_VGGface\VGG_facerecognition\photo_low\';
    if ~exist(dst, 'dir')
        mkdir(dst);
        mkdir([dst 'ProbeScore/']);
    end
  
srch = 'F:\zn1\znMCM\MsCeleb1M_code\code_face_recognition_enhancedface_with_VGGface\VGG_feature_output\high\';
dh = dir(srch);
