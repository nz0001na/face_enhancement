...
%% before enhancement
src = 'F:\zn1\znMCM\MsCeleb1M_code\code_deep_fr\face_recognition_result\IJBA_dataset\VGGface\0126_V2_middle\';
...
axis([0 50 0 1]);
title('Middle Quality vs. High Quality using Deblurring','FontSize',15);
set(gca,'fontweight','bold','FontSize',15);
grid on;
hold on;

%% photo measure all high
src = 'F:\zn1\znMCM\MsCeleb1M_code\code_face_recognition_enhancedface_with_VGGface\VGG_facerecognition\deblur_middle\';
curvedata = csvread([src 'listcmck.csv']); 
