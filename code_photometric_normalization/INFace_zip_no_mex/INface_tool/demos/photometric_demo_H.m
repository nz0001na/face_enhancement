...
%creat result file
dst = 'F:\zn1\znMCM\MsCeleb1M_code\phometric_norm_output\high_QA\';
    if ~exist(dst, 'dir')
        mkdir('F:\zn1\znMCM\MsCeleb1M_code\phometric_norm_output\high_QA\');  
    end
    
% illumlist = 'F:\zn1\znMCM\MsCeleb1M_code\code_openface\illum\high\';
...
for n = 1:length(nameFolds)
    ...
    %images
    src = [ pathFolder '/' subject_id '/high/'];
    files = dir([src '*.jpg']);
    %list
